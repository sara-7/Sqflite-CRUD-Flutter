...
class _ContactScreenState extends State<ContactScreen> {
  ...
  Future<void> create() async {
    bool b = await Provider.of<ContactProvider>(context, listen: false).create(contact);
    if(b){
      showSnackBar(
          context: context, message: 'success', error: false);
    }else {
      showSnackBar(
          context: context, message: 'not success', error: true);
